...
public final class TikvServiceImpl extends TikvGrpc.TikvImplBase {
    ...
    // ---- Transactional KV ----
    @Override public void kvGet(GetRequest r, StreamObserver<GetResponse> o)              { dispatchTxn(o, () -> txn.kvGet(r)); }
    @Override public void kvScan(ScanRequest r, StreamObserver<ScanResponse> o)           { dispatchTxn(o, () -> txn.kvScan(r)); }
    @Override public void kvBatchGet(BatchGetRequest r, StreamObserver<BatchGetResponse> o) { dispatchTxn(o, () -> txn.kvBatchGet(r)); }
    @Override public void kvPrewrite(PrewriteRequest r, StreamObserver<PrewriteResponse> o) { dispatchTxn(o, () -> txn.kvPrewrite(r)); }
    @Override public void kvPessimisticLock(PessimisticLockRequest r, StreamObserver<PessimisticLockResponse> o) { dispatchTxn(o, () -> txn.kvPessimisticLock(r)); }
    @Override public void kvPessimisticRollback(PessimisticRollbackRequest r, StreamObserver<PessimisticRollbackResponse> o) { dispatchTxn(o, () -> txn.kvPessimisticRollback(r)); }
    @Override public void kvCommit(CommitRequest r, StreamObserver<CommitResponse> o)     { dispatchTxn(o, () -> txn.kvCommit(r)); }
    @Override public void kvCleanup(CleanupRequest r, StreamObserver<CleanupResponse> o)  { dispatchTxn(o, () -> txn.kvCleanup(r)); }
    @Override public void kvBatchRollback(BatchRollbackRequest r, StreamObserver<BatchRollbackResponse> o) { dispatchTxn(o, () -> txn.kvBatchRollback(r)); }
    @Override public void kvCheckTxnStatus(CheckTxnStatusRequest r, StreamObserver<CheckTxnStatusResponse> o) { dispatchTxn(o, () -> txn.kvCheckTxnStatus(r)); }
    @Override public void kvCheckSecondaryLocks(CheckSecondaryLocksRequest r, StreamObserver<CheckSecondaryLocksResponse> o) { dispatchTxn(o, () -> txn.kvCheckSecondaryLocks(r)); }
    @Override public void kvScanLock(ScanLockRequest r, StreamObserver<ScanLockResponse> o) { dispatchTxn(o, () -> txn.kvScanLock(r)); }
    @Override public void kvResolveLock(ResolveLockRequest r, StreamObserver<ResolveLockResponse> o) { dispatchTxn(o, () -> txn.kvResolveLock(r)); }
    @Override public void kvTxnHeartBeat(TxnHeartBeatRequest r, StreamObserver<TxnHeartBeatResponse> o) { dispatchTxn(o, () -> txn.kvTxnHeartBeat(r)); }
    @Override public void kvGC(GCRequest r, StreamObserver<GCResponse> o)                 { dispatchTxn(o, () -> txn.kvGC(r)); }
    @Override public void kvDeleteRange(DeleteRangeRequest r, StreamObserver<DeleteRangeResponse> o) { dispatchTxn(o, () -> txn.kvDeleteRange(r)); }

    // ---- Raw KV ----
    @Override public void rawGet(RawGetRequest r, StreamObserver<RawGetResponse> o)            { dispatchRaw(o, () -> rawKv.rawGet(r)); }
    @Override public void rawBatchGet(RawBatchGetRequest r, StreamObserver<RawBatchGetResponse> o) { dispatchRaw(o, () -> rawKv.rawBatchGet(r)); }
    @Override public void rawPut(RawPutRequest r, StreamObserver<RawPutResponse> o)            { dispatchRaw(o, () -> rawKv.rawPut(r)); }
    @Override public void rawBatchPut(RawBatchPutRequest r, StreamObserver<RawBatchPutResponse> o) { dispatchRaw(o, () -> rawKv.rawBatchPut(r)); }
    @Override public void rawDelete(RawDeleteRequest r, StreamObserver<RawDeleteResponse> o)   { dispatchRaw(o, () -> rawKv.rawDelete(r)); }
    @Override public void rawBatchDelete(RawBatchDeleteRequest r, StreamObserver<RawBatchDeleteResponse> o) { dispatchRaw(o, () -> rawKv.rawBatchDelete(r)); }
    @Override public void rawScan(RawScanRequest r, StreamObserver<RawScanResponse> o)         { dispatchRaw(o, () -> rawKv.rawScan(r)); }
    @Override public void rawDeleteRange(RawDeleteRangeRequest r, StreamObserver<RawDeleteRangeResponse> o) { dispatchRaw(o, () -> rawKv.rawDeleteRange(r)); }
    @Override public void rawCAS(RawCASRequest r, StreamObserver<RawCASResponse> o)            { dispatchRaw(o, () -> rawKv.rawCAS(r)); }
    ...
    // ---- MVCC inspection ----
    @Override public void mvccGetByKey(MvccGetByKeyRequest r, StreamObserver<MvccGetByKeyResponse> o) { dispatchTxn(o, () -> txn.kvMvccGetByKey(r)); }
    @Override public void mvccGetByStartTs(MvccGetByStartTsRequest r, StreamObserver<MvccGetByStartTsResponse> o) { dispatchTxn(o, () -> txn.kvMvccGetByStartTs(r)); }
    ...
    private BatchCommandsResponse.Response dispatchOne(BatchCommandsRequest.Request req) {
        ...
        try {
            switch (req.getCmdCase()) {
                ...
                case BATCHROLLBACK -> { if (txn != null) rb.setBatchRollback(txn.kvBatchRollback(req.getBatchRollback())); }
                ...
                case PESSIMISTICLOCK -> { if (txn != null) rb.setPessimisticLock(txn.kvPessimisticLock(req.getPessimisticLock())); }
                case PESSIMISTICROLLBACK -> { if (txn != null) rb.setPessimisticRollback(txn.kvPessimisticRollback(req.getPessimisticRollback())); }
                case CHECKTXNSTATUS -> { if (txn != null) rb.setCheckTxnStatus(txn.kvCheckTxnStatus(req.getCheckTxnStatus())); }
                case CHECKSECONDARYLOCKS -> { if (txn != null) rb.setCheckSecondaryLocks(txn.kvCheckSecondaryLocks(req.getCheckSecondaryLocks())); }
                ...
                case RAWBATCHDELETE -> { if (rawKv != null) rb.setRawBatchDelete(rawKv.rawBatchDelete(req.getRawBatchDelete())); }
                case RAWSCAN -> { if (rawKv != null) rb.setRawScan(rawKv.rawScan(req.getRawScan())); }
                case RAWDELETERANGE -> { if (rawKv != null) rb.setRawDeleteRange(rawKv.rawDeleteRange(req.getRawDeleteRange())); }
